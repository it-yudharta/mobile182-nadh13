package com.anas.aplikasinovel.constants;
...
public class NavigationDrawerConstants {
    ...
    public final static String TAG_LIST = "Daftar Isi";
    public final static String TAG_VIDEOS = "Videos";
    public final static String TAG_SETTINGS = "Settings";
    public final static String SITE_EMAIL = "neotsuki77@gmail.com";
    public final static String SHARE_TITLE = "Android Development Tutorials";
    public final static String SHARE_MESSAGE = "Hey Friend, I have found an awesome website for learning Android Programming: http://google.com";
